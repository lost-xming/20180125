    ...
    return function(A) {
        ...
        var s = e.Bounds = function() {
            ...
            o = (e.parseBounds = function(A, e, t) {
                ...
                default ? n.push(A.subdivide(.5, !1)) : n.push(A), t instanceof B.
                default ? n.push(t.subdivide(.5, !0)) : n.push(t), r instanceof B.
                default ? n.push(r.subdivide(.5, !0).reverse()) : n.push(r), e instanceof B.
                default ? n.push(e.subdivide(.5, !1).reverse()) : n.push(e), n
            }),
        ...
        var c = e.BACKGROUND_REPEAT = {
            ...
            w = function A(e) {
                ...
                return a[0].value && (r = a[0].value.getAbsoluteValue(t.width)), a[0].size === l.AUTO && a[1].size === l.AUTO ? n = e.height : a[1].size === l.AUTO ? n = r / e.width * e.height : a[1].value && (n = a[1].value.getAbsoluteValue(t.height)), a[0].size === l.AUTO && (r = n / e.height * e.width), new B.
                default (r, n)
        ...
        e.parseTextDecoration = function(A) {
            ...
            return null === t ? s.NONE : {
                ...
                default (A.textDecorationColor) : null,
        ...
        e.parseBorder = function(A) {
            return o.map(function(e) {
                var t = new B.
                default (A.getPropertyValue("border-" + e + "-color")), r = function(A) {
                    switch (A) {
                        case "none":
                            return a.NONE
                    }
        ...
        var i = ["OL", "UL", "MENU"],
            c = (e.getListOwner = function(A) {
                ...
                if (s) {
                    ...
                    U.appendChild(i), c ? (e.childNodes.push(B.
        ...
        default ([42, 42, 42]);
        var u = new o.
        default ([165, 165, 165]), Q = new o.
        default ([222, 222, 222]), w = {
            borderWidth: 1,
            borderColor: u,
        ...
        default ("50%")), g = [U, U], C = [g, g, g, g], d = new i.
        default ("3px"), F = [d, d], E = [F, F, F, F], f = (e.getInputBorderRadius = function(A) {
            ...
            if (A.length > 0 && B) {
                ...
                a.appendChild(s), B.appendChild(a), t.childNodes.push(r.
                default.fromTextNode(s, t)), B.removeChild(a)
            }
        }), h = function(A) {
        ...
        e.Proxy = function(A, e) {
            ...
            return new Promise(function(r, n) {
                ...
                default.SUPPORT_RESPONSE_TYPE ? "blob" : "text", s = B.
        ...
        e.renderElement = function A(e, t, Q) {
            ...
            default (getComputedStyle(w.documentElement).backgroundColor) : l.TRANSPARENT, C = w.body ? new u.
            default (getComputedStyle(w.body).backgroundColor) : l.TRANSPARENT, d = e === w.documentElement ? g.isTransparent() ? C.isTransparent() ? t.backgroundColor ? new u.
            default (t.backgroundColor) : null : C : g : t.backgroundColor ? new u.
            default (t.backgroundColor) : null;
            return (t.foreignObjectRendering ? s.
            default.SUPPORT_FOREIGNOBJECT_DRAWING : Promise.resolve(!1)).then(function(s) {
                return s ? (o = new i.DocumentCloner(e, t, Q, !0, A)).inlineFonts(w).then(function() {
                    return o.resourceLoader.ready()
                }).then(function() {
                    return new a.
                    default (o.documentElement).render({
                        backgroundColor: d,
                        logger: Q,
                        scale: t.scale,
                        x: t.x,
                    ...
                    return d === i.container.style.background.backgroundColor && (i.container.style.background.backgroundColor = l.TRANSPARENT), o.ready().then(function(A) {
                        ...
                        if (Array.isArray(t.target)) return Promise.all(t.target.map(function(A) {
                            return new B.
                            default (A, r).render(i)
                        }));
                        var n = new B.
                        default (t.target, r).render(i);
            ...
            g = e.GRADIENT_TYPE = {
                ...
                for (var r = [], n = e; n < A.length; n++) {
                    var a = A[n],
                        ...
                        i = a.lastIndexOf(" "),
                        c = new B.
                    default (o ? a.substring(0, i) : a), l = o ? new s.
                    default (a.substring(i + 1)) : n === e ? new s.
                    default ("0%") : n === A.length - 1 ? new s.
                    default ("100%") : null;
                    r.push({
                        color: c,
                        stop: l
        ...
        var Q = e.DocumentCloner = function() {
            function A(e, t, r, n, B) {
                ! function(A, e) {
                    if (!(A instanceof e)) throw new TypeError("Cannot call a class as a function")
                }(this, A), this.referenceElement = e, this.scrolledElements = [], this.copyStyles = n, this.inlineImages = n, this.logger = r, this.options = t, this.renderer = B, this.resourceLoader = new s.
                default (t, r, window), this.pseudoContentData = {
                    counters: {},
                    quoteDepth: 0
        ...
        var i = function() {
            ...
            return n(A, [{
                ...
                value: function(A, e, t) {
                    ...
                    default.SUPPORT_BASE64_DRAWING(e).then(n) : n(!0), A
                }
            }, {
                key: "isSameOrigin",
                value: function(A) {
